# Lagoon Project Instructions

This project inherits global Codex guidance from `C:\Users\isaac\.codex\AGENTS.md`.
...
## Current Repo Notes
- Repo is minimal right now: `.git`, `.uv-cache`, and `docs/`.
- No project-specific build, lint, or test command has been identified yet. Discover commands from future project files before running broad checks.
