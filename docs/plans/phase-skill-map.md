...
| `SP-02 Lecture Media Import` | `Superpowers:test-driven-development`, `Superpowers:systematic-debugging`, `Browser:browser` | `playwright` for scripted E2E, `screenshot` for visual import issues, `web-design-guidelines` for UI review |
